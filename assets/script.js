 // Define questions (All questions found on Quizlet)
 const questions = [
    {
...
// when all questions are answered OR timer reaches 0, run gameOver function
function gameOver() {
...
function showHighScores() {
    ...
    // check if there are any already in local storage
    if (savedHighScores === null) {
        return;
    }
